...
const Projects = () => {
    ...
    >
      <div className="mx-40 h-[100%]">
        <section>
          ...
          <article class="pt-8 flex flex-row-reverse">
            <div class="text">
              ...
              <p className="">
                ...
                anywhere in the description. Live link to the project <a className="underline decoration-auto hover:no-underline" href="https://642d8bcddb12244c5445799f--cryto-explorer-m4h4nk4l1.netlify.app/">netlify</a>.
          ...
          <article className="pt-8 flex flex-row">
            <div >
              ...
              <p class>
                ...
                <a className="underline decoration-auto hover:no-underline" href="https://github.com/m4h4nk4l1/reactJS-construction">
                   Link
                </a>
                .
              </p>
          ...
          <article className="pt-8 flex flex-row-reverse">
            <div >
              <h3 className="text-2xl font-semibold">Multiple Javascript Features</h3>
              <p class>
                It is a online purchasing construction material ecommerce site
                where you can purchase different construction materials of
                different brands listed. It is a frontend website with
          ...
          <div class="flex flex-col h-screen bg-center bg-cover ">
			<div class="grid place-items-center w-4/5 mx-auto p-10 my-20 sm:my-auto bg-white-600 border-4 border-black bg-opacity-70 rounded-xl shadow-2xl space-y-5 text-center">
  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-1 0A7 7 0 1 0 1 8a7 7 0 0 0 14 0z"/>
				...
				<h1 class="text-4xl font-bold uppercase text-black transition duration-500">Coming Soon</h1>
        <h2 class="text-xl text-black font-semibold"> I Building more. Checkout later.......</h2>
